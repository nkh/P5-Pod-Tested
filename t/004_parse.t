...
EOE
	...
	is($parsed_text,$expected_text, 'input through file') ;
	}

}

{
local $Plan = {'=begin not_tested' => 3} ;
...
my $hdr = Data::HexDump::Range->new() ;
	...
	is($parsed_text,$expected_text, '=begin not_tested') 
	or do
		{
		diag $hdr->dump([['parsed', 1000]], $parsed_text) ;
		diag "\n\n" ;
		diag $hdr->dump([['expected', 1000]], $expected_text) ;
		};
	}
